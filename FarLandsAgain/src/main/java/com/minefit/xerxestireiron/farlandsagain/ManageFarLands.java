...
public class ManageFarLands {
    ...
    public ManageFarLands(World world, FarLandsAgain instance) {
        ...
        if (this.plugin.version.equals("v1_8_R3")) {
            this.LF8R3 = new com.minefit.xerxestireiron.farlandsagain.v1_8_R3.LoadFarlands(this.world, worldConfig,
                    this.plugin.getName());
        } else if (this.plugin.version.equals("v1_9_R1")) {
            this.LF9R1 = new com.minefit.xerxestireiron.farlandsagain.v1_9_R1.LoadFarlands(this.world, worldConfig,
                    this.plugin.getName());
        } else if (this.plugin.version.equals("v1_9_R2")) {
            this.LF9R2 = new com.minefit.xerxestireiron.farlandsagain.v1_9_R2.LoadFarlands(this.world, worldConfig,
                    this.plugin.getName());
        } else if (this.plugin.version.equals("v1_10_R1")) {
            this.LF10R1 = new com.minefit.xerxestireiron.farlandsagain.v1_10_R1.LoadFarlands(this.world, worldConfig,
                    this.plugin.getName());
        } else if (this.plugin.version.equals("v1_11_R1")) {
            this.LF11R1 = new com.minefit.xerxestireiron.farlandsagain.v1_11_R1.LoadFarlands(this.world, worldConfig,
                    this.plugin.getName());
