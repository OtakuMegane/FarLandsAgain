...
import net.minecraft.server.v1_10_R1.BlockChorusFlower;
...
import net.minecraft.server.v1_10_R1.ChunkProviderTheEnd;
...
import net.minecraft.server.v1_10_R1.NoiseGenerator3Handler;
import net.minecraft.server.v1_10_R1.World;
import net.minecraft.server.v1_10_R1.WorldGenEndCity;
import net.minecraft.server.v1_10_R1.WorldGenEndIsland;

public class FLAChunkProviderTheEnd extends ChunkProviderTheEnd implements ChunkGenerator {
    ...
    public FLAChunkProviderTheEnd(ConfigurationSection config, World world, boolean flag, long i) {
        super(world, flag, i);
        this.l = world;
        this.m = flag;
        this.h = new Random(i);
                    ...
                    for (int l1 = 0; l1 < 4; ++l1) {
                        ...
                        for (int i2 = 0; i2 < 8; ++i2) {
                            ...
                            for (int j2 = 0; j2 < 8; ++j2) {
                                IBlockData iblockdata = FLAChunkProviderTheEnd.b;

                                if (d15 > 0.0D) {
                                    iblockdata = FLAChunkProviderTheEnd.a;
                                }
    ...
    public void a(ChunkSnapshot chunksnapshot) {
        for (int i = 0; i < 16; ++i) {
            for (int j = 0; j < 16; ++j) {
                byte b0 = 1;
                int k = -1;
                IBlockData iblockdata = FLAChunkProviderTheEnd.a;
                IBlockData iblockdata1 = FLAChunkProviderTheEnd.a;
                ...
                for (int l = 127; l >= 0; --l) {
                    ...
                    if (iblockdata2.getMaterial() == Material.AIR) {
                        ...
                        if (k == -1) {
                            if (b0 <= 0) {
                                iblockdata = FLAChunkProviderTheEnd.b;
                                iblockdata1 = FLAChunkProviderTheEnd.a;
                            }
    ...
    public void recreateStructures(int i, int j) {
        ...
        if (k > 4096L) {
            ...
            if (f < -20.0F && this.h.nextInt(14) == 0) {
                this.r.generate(this.l, this.h,
                        blockposition.a(this.h.nextInt(16) + 8, 55 + this.h.nextInt(16), this.h.nextInt(16) + 8));
            ...
            if (this.a(i, j, 1, 1) > 40.0F) {
                ...
                for (int i1 = 0; i1 < l; ++i1) {
                    ...
                    if (l1 > 0) {
                        ...
                        if (this.l.isEmpty(blockposition.a(j1, i2 + 1, k1))
                                && this.l.getType(blockposition.a(j1, i2, k1)).getBlock() == Blocks.END_STONE) {
