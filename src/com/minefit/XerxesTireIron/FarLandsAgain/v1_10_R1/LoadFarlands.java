...
import com.minefit.XerxesTireIron.FarLandsAgain.v1_10_R1.FLAChunkProviderGenerate;
import com.minefit.XerxesTireIron.FarLandsAgain.v1_10_R1.FLAChunkProviderHell;
import com.minefit.XerxesTireIron.FarLandsAgain.v1_10_R1.FLAChunkProviderTheEnd;
    ...
    public void overrideGenerator() {
        ...
        try {
            ...
            if (environment == Environment.NORMAL) {
                ...
                FLAChunkProviderHell generator = new FLAChunkProviderHell(worldConfig, this.nmsWorld, genFeatures, this.nmsWorld.getSeed(), this.plugin);
                setFinal(cp, generator);
