...
import net.minecraft.server.v1_11_R1.ChunkProviderTheEnd;
import net.minecraft.server.v1_11_R1.ChunkSnapshot;
import net.minecraft.server.v1_11_R1.IBlockData;
import net.minecraft.server.v1_11_R1.Material;
import net.minecraft.server.v1_11_R1.MathHelper;
import net.minecraft.server.v1_11_R1.NoiseGenerator3Handler;
import net.minecraft.server.v1_11_R1.TileEntity;
import net.minecraft.server.v1_11_R1.TileEntityEndGateway;
import net.minecraft.server.v1_11_R1.World;
import net.minecraft.server.v1_11_R1.WorldGenEndCity;
import net.minecraft.server.v1_11_R1.WorldGenEndGateway;
import net.minecraft.server.v1_11_R1.WorldGenEndIsland;
