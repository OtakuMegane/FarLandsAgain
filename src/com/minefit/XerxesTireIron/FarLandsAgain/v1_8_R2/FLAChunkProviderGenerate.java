...
import net.minecraft.server.v1_8_R2.CustomWorldSettingsFinal;
import net.minecraft.server.v1_8_R2.IChunkProvider;
import net.minecraft.server.v1_8_R2.MathHelper;
import net.minecraft.server.v1_8_R2.NoiseGenerator3;
import net.minecraft.server.v1_8_R2.SpawnerCreature;
...
import net.minecraft.server.v1_8_R2.WorldGenDungeons;
import net.minecraft.server.v1_8_R2.WorldGenLakes;
import net.minecraft.server.v1_8_R2.WorldGenLargeFeature;
import net.minecraft.server.v1_8_R2.WorldGenMineshaft;
import net.minecraft.server.v1_8_R2.WorldGenMonument;
import net.minecraft.server.v1_8_R2.WorldGenStronghold;
import net.minecraft.server.v1_8_R2.WorldGenVillage;
