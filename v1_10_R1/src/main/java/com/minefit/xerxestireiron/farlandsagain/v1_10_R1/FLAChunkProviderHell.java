...
import net.minecraft.server.v1_10_R1.BlockPredicate;
...
import net.minecraft.server.v1_10_R1.WorldGenFire;
import net.minecraft.server.v1_10_R1.WorldGenHellLava;
import net.minecraft.server.v1_10_R1.WorldGenLightStone1;
import net.minecraft.server.v1_10_R1.WorldGenLightStone2;
import net.minecraft.server.v1_10_R1.WorldGenMinable;
import net.minecraft.server.v1_10_R1.WorldGenMushrooms;
