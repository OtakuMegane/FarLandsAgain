...
public class FLAChunkProviderGenerate extends ChunkProviderGenerate {
    ...
    public FLAChunkProviderGenerate(GeneratorAccess generatoraccess, WorldChunkManager worldchunkmanager, GeneratorSettingsOverworld generatorsettingsoverworld, ConfigValues configValues, ChunkGenerator<?> originalGenerator) {
