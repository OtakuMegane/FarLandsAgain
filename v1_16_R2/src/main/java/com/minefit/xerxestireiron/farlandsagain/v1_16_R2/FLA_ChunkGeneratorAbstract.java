...
public final class FLA_ChunkGeneratorAbstract extends ChunkGenerator {
    ...
    public FLA_ChunkGeneratorAbstract(WorldChunkManager worldchunkmanager, long i,  Supplier<GeneratorSettingBase> supplier, ConfigValues configValues, ChunkGenerator originalGenerator) {
        this(worldchunkmanager, worldchunkmanager, i, supplier, configValues, originalGenerator);
    }

    private FLA_ChunkGeneratorAbstract(WorldChunkManager worldchunkmanager, WorldChunkManager worldchunkmanager1, long i,  Supplier<GeneratorSettingBase> supplier, ConfigValues configValues, ChunkGenerator originalGenerator) {
