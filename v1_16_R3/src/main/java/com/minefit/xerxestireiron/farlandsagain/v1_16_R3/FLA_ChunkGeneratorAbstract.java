...
public final class FLA_ChunkGeneratorAbstract extends ChunkGenerator {
    ...
    public FLA_ChunkGeneratorAbstract(WorldChunkManager worldchunkmanager, long i, Supplier<GeneratorSettingBase> supplier) {
        this(worldchunkmanager, worldchunkmanager, i, supplier, null, null, 4);
    }

    public FLA_ChunkGeneratorAbstract(WorldChunkManager worldchunkmanager, long i,  Supplier<GeneratorSettingBase> supplier, ConfigValues configValues, ChunkGenerator originalGenerator, int divisor) {
        this(worldchunkmanager, worldchunkmanager, i, supplier, configValues, originalGenerator, divisor);
    }

    private FLA_ChunkGeneratorAbstract(WorldChunkManager worldchunkmanager, WorldChunkManager worldchunkmanager1, long i,  Supplier<GeneratorSettingBase> supplier, ConfigValues configValues, ChunkGenerator originalGenerator, int divisor) {
        ...
        try {
            ...
            Field pField = ReflectionHelper.getField(this.h.get().getClass(), "p", true);
            pField.setAccessible(true);
            this.mobH = pField.getBoolean(this.h.get());
        } catch (Exception e) {
            e.printStackTrace();
        }
