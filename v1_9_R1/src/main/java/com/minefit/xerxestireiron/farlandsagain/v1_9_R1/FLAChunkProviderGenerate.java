...
import net.minecraft.server.v1_9_R1.CustomWorldSettingsFinal;
import net.minecraft.server.v1_9_R1.EnumCreatureType;
import net.minecraft.server.v1_9_R1.IBlockData;
import net.minecraft.server.v1_9_R1.MathHelper;
import net.minecraft.server.v1_9_R1.NoiseGenerator3;
...
import net.minecraft.server.v1_9_R1.WorldGenMonument;
...
public class FLAChunkProviderGenerate implements ChunkGenerator {
    ...
    public BlockPosition findNearestMapFeature(World world, String s, BlockPosition blockposition) {
        return "Stronghold".equals(s) && this.w != null ? this.w.getNearestGeneratedFeature(world, blockposition)
                : null;
    }
