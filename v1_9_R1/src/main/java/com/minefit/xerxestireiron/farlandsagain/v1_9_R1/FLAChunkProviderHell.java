...
import net.minecraft.server.v1_9_R1.BlockPredicate;
...
import net.minecraft.server.v1_9_R1.WorldGenBase;
import net.minecraft.server.v1_9_R1.WorldGenCavesHell;
import net.minecraft.server.v1_9_R1.WorldGenFire;
import net.minecraft.server.v1_9_R1.WorldGenHellLava;
import net.minecraft.server.v1_9_R1.WorldGenLightStone1;
import net.minecraft.server.v1_9_R1.WorldGenLightStone2;
import net.minecraft.server.v1_9_R1.WorldGenMinable;
import net.minecraft.server.v1_9_R1.WorldGenMushrooms;
import net.minecraft.server.v1_9_R1.WorldGenNether;
import net.minecraft.server.v1_9_R1.WorldGenerator;
