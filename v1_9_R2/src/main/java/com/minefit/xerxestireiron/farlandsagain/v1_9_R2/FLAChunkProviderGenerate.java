...
import net.minecraft.server.v1_9_R2.CustomWorldSettingsFinal;
import net.minecraft.server.v1_9_R2.EnumCreatureType;
import net.minecraft.server.v1_9_R2.IBlockData;
import net.minecraft.server.v1_9_R2.MathHelper;
import net.minecraft.server.v1_9_R2.NoiseGenerator3;
...
import net.minecraft.server.v1_9_R2.WorldGenDungeons;
import net.minecraft.server.v1_9_R2.WorldGenLakes;
import net.minecraft.server.v1_9_R2.WorldGenLargeFeature;
import net.minecraft.server.v1_9_R2.WorldGenMineshaft;
import net.minecraft.server.v1_9_R2.WorldGenMonument;
import net.minecraft.server.v1_9_R2.WorldGenStronghold;
import net.minecraft.server.v1_9_R2.WorldGenVillage;
import net.minecraft.server.v1_9_R2.WorldType;

public class FLAChunkProviderGenerate implements ChunkGenerator {
                    ...
                    for (int l2 = 0; l2 < 8; ++l2) {
                        ...
                        for (int i3 = 0; i3 < 4; ++i3) {
                            ...
                            for (int j3 = 0; j3 < 4; ++j3) {
                                if ((d16 += d15) > 0.0D) {
                                    chunksnapshot.a(k * 4 + i3, k2 * 8 + l2, j1 * 4 + j3, FLAChunkProviderGenerate.a);
    ...
    public Chunk getOrCreateChunk(int i, int j) {
        ...
        if (this.s.z && this.configValues.paperSpigot.generateCanyon) {
